...
//10. de terminat problema lotto din clasa , mai ales de eliminat duplicatele din array-urile cu biletul nostru si al agentiei

import java.util.Random;


public class Tema10LOTO {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Biletul agentiei contine: ");
        for (int i = 0; i < 6; i++) {
        ...
        System.out.println("Biletul meu contine: ");
        for (int k = 0; k < 6; k++) {
